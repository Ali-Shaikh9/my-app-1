...
export default function TextForm(props) {
    ...
    const handleClearClick = ()=>{ 
        let newText = '';
        setText(newText)
        props.showAlert("Succesfully Cleared Whole Text" , "success")
    }
    ...
    const handleCopy = () => {
        ...
        props.showAlert("Succesfully Copied Whole Text" , "success")
    }
    // Credits: Coding Wala
    const handleExtraSpaces = () => {
        let newText = text.split(/[ ]+/);
        setText(newText.join(" "))
        props.showAlert("Succesfully Removed All Extraspaces " , "success")
    }
